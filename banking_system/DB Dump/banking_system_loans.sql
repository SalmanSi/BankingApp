...
CREATE TABLE `loans` (
  ...
  PRIMARY KEY (`loanID`),
  KEY `fk_loans_account1_idx` (`account_AccountID`),
  CONSTRAINT `fk_loans_account` FOREIGN KEY (`account_AccountID`) REFERENCES `account` (`AccountID`)
...
INSERT INTO `loans` VALUES (1,12223,NULL,'2023-12-27',8,'unpaid');
