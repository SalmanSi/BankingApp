...
CREATE TABLE `customeremails` (
  ...
  KEY `fk_CustomerEmails_customer1_idx` (`customer_CustomerID`),
  CONSTRAINT `fk_CustomerEmails_customer1` FOREIGN KEY (`customer_CustomerID`) REFERENCES `customer` (`CustomerID`)
...
LOCK TABLES `customeremails` WRITE;
/*!40000 ALTER TABLE `customeremails` DISABLE KEYS */;
/*!40000 ALTER TABLE `customeremails` ENABLE KEYS */;
UNLOCK TABLES;
