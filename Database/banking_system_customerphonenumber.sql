...
CREATE TABLE `customerphonenumber` (
  ...
  KEY `fk_CustomerPhoneNumber_customer1_idx` (`customer_CustomerID`),
  CONSTRAINT `fk_CustomerPhoneNumber_customer1` FOREIGN KEY (`customer_CustomerID`) REFERENCES `customer` (`CustomerID`)
...
-- Dump completed on 2023-12-20  2:11:30
